...
import { InvestigationStatusBadge, RiskLevelBadge } from "@/features/admin/risk/risk-demo-page";
import type { DemoRiskDetailLoaderData } from "@/features/admin/risk/risk-detail-demo-loader";
import {
...
export function DemoRiskInvestigationDetailPage({
  loaderData,
}: {
  loaderData: DemoRiskDetailLoaderData;
}) {
